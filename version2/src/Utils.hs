...
module Utils
    ...
    , stringToPPKH
    , stringToWriteTestMintingPolicy
    , stringToWriteScriptValidator
    ) where
...
stringToWriteTestMintingPolicy :: FilePath -> String -> IO (Either (FileError ()) ())
stringToWriteTestMintingPolicy filePath = writeMintingPolicy filePath . Test_Token.policy . stringToPPKH 
...
stringToWriteScriptValidator :: FilePath -> String -> IO (Either (FileError ()) ())
stringToWriteScriptValidator filePath = writeScriptValidator filePath . Test_Contract1.validator . stringToPPKH 
